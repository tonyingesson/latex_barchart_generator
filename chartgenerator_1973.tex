...
\pgfplotsset{ every non boxed y axis/.append style={y axis line style=-} }
    ...
    y index=0,col sep=comma]{src.csv};
    	...
    	%Kristdemokraterna
    \addplot [draw,fill=blue!60!black,discard if not={Parti}{Kds}] table [x expr=\coordindex,
    y index=0,col sep=comma]{src.csv};
    ...
    %KFML
    \addplot [draw,fill=red!30!white,discard if not={Parti}{KFML}] table [x expr=\coordindex,
    y index=0,col sep=comma]{src.csv};
