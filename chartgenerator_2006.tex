...
\pgfplotsset{ every non boxed y axis/.append style={y axis line style=-} }
    ...
    \addplot [draw,fill=yellow,discard if not={Parti}{Fi}] table [x expr=\coordindex,
    y index=0,col sep=comma]{src.csv};

    %Piratpartiet
    \addplot [draw,fill=blue!60!black,discard if not={Parti}{Pp}] table [x expr=\coordindex,
    y index=0,col sep=comma]{src.csv};
